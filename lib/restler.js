...
function Request(uri, options) {
 ...
 if (global.headerAuth != null) {
  this.headers['Authorization'] = global.headerAuth;
 }
...
mixin(Request.prototype, {
 ...
 _fireSuccess: function (body, response) {
  ...
  if (typeof body === 'string' && body.indexOf('Unauthorized') != -1) {
   this.emit('unauthorized', null, null);
  }
  else {
